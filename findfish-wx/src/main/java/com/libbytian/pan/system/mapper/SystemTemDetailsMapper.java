...
public interface SystemTemDetailsMapper extends BaseMapper<SystemTemDetailsModel> {
    ...
    IPage<SystemTemDetailsModel> selectTemDetailsPage(Page page, @Param("templateId") String templateId);
    ...
    int deleteTemplateDetails(@Param(value = "list") List<String> temdetailsId);
